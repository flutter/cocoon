...
abstract class GitValidation {
  ...
  static late final RegExp regex;

  /// Returns the error message when the regex validation fails.
  static late final RegExp errorMsg;
...
class CandidateBranch extends GitValidation {
  static final RegExp regex = RegExp(r'^flutter-(\d+)\.(\d+)-candidate\.(\d+)$');
  static final String errorMsg = "Must be a valid candidate branch string, e.g. 'flutter-1.2-candidate.3'";
