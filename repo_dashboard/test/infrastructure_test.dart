...
import 'package:repository_dashboard/details/infrastructure.dart';
import 'package:repository_dashboard/models/build_status.dart';
import 'package:repository_dashboard/models/status_page_status.dart';
...
void main() {
  ...
  group('Post-commit test widget', () {
    ...
    }, skip: true); // Network images failing in tests
  });
}
