...
String _generateLicense(String prefix) {
  return '${prefix}Copyright (2014|2015|2016|2017|2018|2019|2020|2021|2022|2023|2024|2025|2026) The Flutter Authors. All rights reserved.\n'
...
Iterable<File> _allFiles(
  ...
  while (pending.isNotEmpty) {
    ...
    if (entity is File) {
      ...
      if (path.basename(entity.path).endsWith('mocks.dart')) continue;
