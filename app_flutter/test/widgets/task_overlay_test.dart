...
void main() {
  testWidgets('TaskOverlay shows on click', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(MaterialApp),
        matchesGoldenFile('task_overlay_test.normal_overlay_closed.png'));
    ...
    await expectLater(find.byType(MaterialApp),
        matchesGoldenFile('task_overlay_test.normal_overlay_open.png'));
  ...
  testWidgets('TaskOverlay shows when flaky is true',
    ...
    await expectLater(find.byType(MaterialApp),
        matchesGoldenFile('task_overlay_test.flaky_overlay_closed.png'));
    ...
    await expectLater(find.byType(MaterialApp),
        matchesGoldenFile('task_overlay_test.flaky_overlay_open.png'));
  });
  ...
  testWidgets('TaskOverlay shows the right message for nondevicelab tasks',
    ...
    expect(find.text(expectedTaskInfoString), findsNothing);
    await expectLater(find.byType(MaterialApp),
        matchesGoldenFile('task_overlay_test.nondevicelab_closed.png'));
    ...
    expect(find.text(expectedTaskInfoString), findsOneWidget);
    await expectLater(find.byType(MaterialApp),
        matchesGoldenFile('task_overlay_test.nondevicelab_open.png'));
  });
