...
void main() {
  ...
  testWidgets('Skipped tasks do not break the grid',
    ...
    await expectLater(find.byType(TaskGrid),
        matchesGoldenFile('task_grid_test.withSkips.png'));
  });
  ...
  testWidgets('TaskGrid honors moreStatusesExist', (WidgetTester tester) async {
    ...
    await expectLater(find.byType(TaskGrid),
        matchesGoldenFile('task_grid_test.withoutL.png'));
    ...
    await expectLater(
        find.byType(TaskGrid), matchesGoldenFile('task_grid_test.withL.png'));
  });
  ...
  testWidgets('TaskGrid can handle all the various different statuses',
    ...
    await expectLater(find.byType(TaskGrid),
        matchesGoldenFile('task_grid_test.differentTypes.png'));
  });
