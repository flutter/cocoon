...
void main() {
  ...
  group('Approval group tests', () {
    ...
    test('Author and reviewer in flutter-hackers, pr approved', () async {
      ...
      expect(
          result.message
              .contains('This PR has met approval requirements for merging.'),
          isTrue);
    });

    test('Author is a NON member and reviewer is a member, needs 1 more review',
        () async {
      // githubService.isTeamMemberMockList = [true, true];
    ...
    test('Author is a member and reviewer is NON member, needs 1 more review',
        () async {
      // githubService.isTeamMemberMockList = [true, true];
      githubService.isTeamMemberMockMap['author1'] = true;
      githubService.isTeamMemberMockMap['keyonghan'] = false;
    ...
    test('Author is NON member and reviewers are members, pr approved',
        () async {
      githubService.isTeamMemberMockMap['author1'] = false;
    ...
    test('Author is member and reviewers are NON members, needs 1 more review',
        () async {
      githubService.isTeamMemberMockMap['author1'] = true;
    ...
    test('Author is NON member and reviewers are NON members, needs 2 reviews',
        () async {
      githubService.isTeamMemberMockMap['author1'] = false;
      githubService.isTeamMemberMockMap['author2'] = false;
      githubService.isTeamMemberMockMap['author3'] = false;
    ...
    test('Author is member and member requests changes, 1 review is needed',
        () async {
      githubService.isTeamMemberMockMap['author1'] = true;
      githubService.isTeamMemberMockMap['keyonghan'] = true;
      final review = constructSingleReviewerReview(
