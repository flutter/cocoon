...
void main() {
  ...
  test('Verify cache storage', () async {
    ...
    final repositoryConfiguration = await repositoryConfigurationManager
        .readRepositoryConfiguration(RepositorySlug('flutter', 'cocoon'));
  ...
  test(
    'Omitted issues_repository assumes provided slug is for issues',
    () async {
      const sampleConfig = '''
      default_branch: main
      auto_approval_accounts:
  ...
  test('Default branch collected if omitted master', () async {
    ...
    final repositoryConfiguration = await repositoryConfigurationManager
        .readRepositoryConfiguration(RepositorySlug('flutter', 'flutter'));
  ...
  group('Merging configurations tests', () {
    ...
    */
    ...
    test('Global config merged with default local config', () {
      ...
      expect(
        mergedRepositoryConfiguration.autoApprovalAccounts.contains(
          'dependabot[bot]',
        ),
        isTrue,
      );
    ...
    test('Approving reviews is overridden by local config', () {
      ...
      final localRepositoryConfiguration = RepositoryConfiguration(
        approvingReviews: expectedApprovingReviews,
      );
      final globalRepositoryConfiguration = RepositoryConfiguration.fromYaml(
        sampleConfigWithOverride,
      );
    ...
    test('Approval group is overridden if defined', () {
      ...
      final localRepositoryConfiguration = RepositoryConfiguration(
        approvalGroup: expectedApprovalGroup,
      );
      final globalRepositoryConfiguration = RepositoryConfiguration.fromYaml(
        sampleConfigWithOverride,
      );
      ...
      expect(
        mergedRepositoryConfiguration.approvalGroup,
        expectedApprovalGroup,
      );
    });
