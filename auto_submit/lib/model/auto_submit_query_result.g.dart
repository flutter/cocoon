...
OuterRevertPullRequest _$OuterRevertPullRequestFromJson(Map<String, dynamic> json) => OuterRevertPullRequest(
      revertPullRequest: json['revertPullRequest'] == null
          ? null
          : RevertPullRequest.fromJson(json['revertPullRequest'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$OuterRevertPullRequestToJson(OuterRevertPullRequest instance) => <String, dynamic>{
