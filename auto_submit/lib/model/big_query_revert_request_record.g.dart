...
RevertRequestRecord _$RevertRequestRecordFromJson(Map<String, dynamic> json) =>
    RevertRequestRecord(
      ...
      reviewIssueCreatedTimestamp: json['review_issue_created_timestamp'] ==
              null
          ? null
...
Map<String, dynamic> _$RevertRequestRecordToJson(
        RevertRequestRecord instance) =>
    <String, dynamic>{
      ...
      'original_pr_created_timestamp':
          instance.originalPrCreatedTimestamp?.toIso8601String(),
      'original_pr_landed_timestamp':
          instance.originalPrLandedTimestamp?.toIso8601String(),
      ...
      'review_issue_created_timestamp':
          instance.reviewIssueCreatedTimestamp?.toIso8601String(),
      'review_issue_landed_timestamp':
          instance.reviewIssueLandedTimestamp?.toIso8601String(),
