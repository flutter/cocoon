...
GetStatusResult _$GetStatusResultFromJson(Map<String, dynamic> json) {
  return GetStatusResult(
      statuses: (json['Statuses'] as List)
          ?.map((dynamic e) => e == null ? null : BuildStatus.fromJson(e as Map<String, dynamic>))
          ?.toList(),
      agentStatuses: (json['AgentStatuses'] as List)
          ?.map((dynamic e) => e == null ? null : AgentStatus.fromJson(e as Map<String, dynamic>))
          ?.toList());
}

Map<String, dynamic> _$GetStatusResultToJson(GetStatusResult instance) =>
    <String, dynamic>{'Statuses': instance.statuses, 'AgentStatuses': instance.agentStatuses};

BuildStatus _$BuildStatusFromJson(Map<String, dynamic> json) {
  return BuildStatus(
      stages: (json['Stages'] as List)
          ?.map((dynamic e) => e == null ? null : Stage.fromJson(e as Map<String, dynamic>))
          ?.toList(),
      checklist:
          json['Checklist'] == null ? null : ChecklistEntity.fromJson(json['Checklist'] as Map<String, dynamic>));
}

Map<String, dynamic> _$BuildStatusToJson(BuildStatus instance) =>
    <String, dynamic>{'Stages': instance.stages, 'Checklist': instance.checklist};
...
AgentStatus _$AgentStatusFromJson(Map<String, dynamic> json) {
  return AgentStatus(
      ...
      healthCheckTimestamp:
          json['HealthCheckTimestamp'] == null ? null : fromMilliseconds(json['HealthCheckTimestamp'] as int),
...
Map<String, dynamic> _$AgentStatusToJson(AgentStatus instance) => <String, dynamic>{
      ...
      'HealthCheckTimestamp':
          instance.healthCheckTimestamp == null ? null : toMilliseconds(instance.healthCheckTimestamp),
...
Map<String, dynamic> _$CommitInfoToJson(CommitInfo instance) =>
    <String, dynamic>{'Sha': instance.sha, 'Author': instance.author};

AuthorInfo _$AuthorInfoFromJson(Map<String, dynamic> json) {
  return AuthorInfo(login: json['Login'] as String, avatarUrl: json['avatar_url'] as String);
}

Map<String, dynamic> _$AuthorInfoToJson(AuthorInfo instance) =>
    <String, dynamic>{'Login': instance.login, 'avatar_url': instance.avatarUrl};
...
Map<String, dynamic> _$ChecklistEntityToJson(ChecklistEntity instance) =>
    <String, dynamic>{'Key': instance.key, 'Checklist': instance.checklist};
...
Checklist _$ChecklistFromJson(Map<String, dynamic> json) {
  return Checklist(
      ...
      createTimestamp: json['CreateTimestamp'] == null ? null : fromMilliseconds(json['CreateTimestamp'] as int));
}
...
Map<String, dynamic> _$ChecklistToJson(Checklist instance) => <String, dynamic>{
      ...
      'CreateTimestamp': instance.createTimestamp == null ? null : toMilliseconds(instance.createTimestamp),
    };
...
Stage _$StageFromJson(Map<String, dynamic> json) {
  return Stage(
      ...
      tasks: (json['Tasks'] as List)
          ?.map((dynamic e) => e == null ? null : TaskEntity.fromJson(e as Map<String, dynamic>))
          ?.toList());
}

Map<String, dynamic> _$StageToJson(Stage instance) => <String, dynamic>{'Name': instance.name, 'Tasks': instance.tasks};
...
Map<String, dynamic> _$TaskEntityToJson(TaskEntity instance) =>
    <String, dynamic>{'Key': instance.key, 'Task': instance.task};
...
Task _$TaskFromJson(Map<String, dynamic> json) {
  return Task(
      ...
      startTimestamp: json['StartTimestamp'] == null ? null : fromMilliseconds(json['StartTimestamp'] as int),
      endTimestamp: json['EndTimestamp'] == null ? null : fromMilliseconds(json['EndTimestamp'] as int),
...
Map<String, dynamic> _$TaskToJson(Task instance) => <String, dynamic>{
      ...
      'StartTimestamp': instance.startTimestamp == null ? null : toMilliseconds(instance.startTimestamp),
      'EndTimestamp': instance.endTimestamp == null ? null : toMilliseconds(instance.endTimestamp),
...
GetBenchmarksResult _$GetBenchmarksResultFromJson(Map<String, dynamic> json) {
  return GetBenchmarksResult(
      benchmarks: (json['Benchmarks'] as List)
          ?.map((dynamic e) => e == null ? null : BenchmarkData.fromJson(e as Map<String, dynamic>))
          ?.toList());
}

Map<String, dynamic> _$GetBenchmarksResultToJson(GetBenchmarksResult instance) =>
    <String, dynamic>{'Benchmarks': instance.benchmarks};
...
BenchmarkData _$BenchmarkDataFromJson(Map<String, dynamic> json) {
  return BenchmarkData(
      ...
      values: (json['Values'] as List)
          ?.map((dynamic e) => e == null ? null : TimeseriesValue.fromJson(e as Map<String, dynamic>))
          ?.toList());
}

Map<String, dynamic> _$BenchmarkDataToJson(BenchmarkData instance) =>
    <String, dynamic>{'Timeseries': instance.timeseries, 'Values': instance.values};
...
GetTimeseriesHistoryResult _$GetTimeseriesHistoryResultFromJson(Map<String, dynamic> json) {
  return GetTimeseriesHistoryResult(
      ...
      lastPosition: json['LastPosition'] == null ? null : fromCursor(json['LastPosition']));
}

Map<String, dynamic> _$GetTimeseriesHistoryResultToJson(GetTimeseriesHistoryResult instance) =>
    <String, dynamic>{'BenchmarkData': instance.benchmarkData, 'LastPosition': instance.lastPosition};
...
Map<String, dynamic> _$TimeseriesEntityToJson(TimeseriesEntity instance) =>
    <String, dynamic>{'Key': instance.key, 'Timeseries': instance.timeseries};
