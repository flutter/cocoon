...
class Invocation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Invocation', package: const $pb.PackageName(_omitMessageNames ? '' : 'luci.resultdb.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..e<Invocation_State>(2, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Invocation_State.STATE_UNSPECIFIED, valueOf: Invocation_State.valueOf, enumValues: Invocation_State.values)
    ...
    ..pc<BigQueryExport>(9, _omitFieldNames ? '' : 'bigqueryExports', $pb.PbFieldType.PM, subBuilder: BigQueryExport.create)
  ...
  @$pb.TagNumber(14)
  set properties($2.Struct v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set sourceSpec(SourceSpec v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set baselineId($core.String v) { $_setString(14, v); }
  @$pb.TagNumber(16)
...
class BigQueryExport_TestResults extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BigQueryExport.TestResults', package: const $pb.PackageName(_omitMessageNames ? '' : 'luci.resultdb.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BigQueryExport_TestResults copyWith(void Function(BigQueryExport_TestResults) updates) => super.copyWith((message) => updates(message as BigQueryExport_TestResults)) as BigQueryExport_TestResults;
  ...
  @$pb.TagNumber(1)
  set predicate($3.TestResultPredicate v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class BigQueryExport_TextArtifacts extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BigQueryExport.TextArtifacts', package: const $pb.PackageName(_omitMessageNames ? '' : 'luci.resultdb.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BigQueryExport_TextArtifacts copyWith(void Function(BigQueryExport_TextArtifacts) updates) => super.copyWith((message) => updates(message as BigQueryExport_TextArtifacts)) as BigQueryExport_TextArtifacts;
  ...
  @$pb.TagNumber(1)
  set predicate($3.ArtifactPredicate v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPredicate() => $_has(0);
  @$pb.TagNumber(1)
  void clearPredicate() => clearField(1);
...
class BigQueryExport extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BigQueryExport', package: const $pb.PackageName(_omitMessageNames ? '' : 'luci.resultdb.v1'), createEmptyInstance: create)
    ..oo(0, [4, 6])
    ..aOS(1, _omitFieldNames ? '' : 'project')
    ..aOS(2, _omitFieldNames ? '' : 'dataset')
    ..aOS(3, _omitFieldNames ? '' : 'table')
    ..aOM<BigQueryExport_TestResults>(4, _omitFieldNames ? '' : 'testResults', subBuilder: BigQueryExport_TestResults.create)
    ..aOM<BigQueryExport_TextArtifacts>(6, _omitFieldNames ? '' : 'textArtifacts', subBuilder: BigQueryExport_TextArtifacts.create)
    ..hasRequiredFields = false
  ;
...
class HistoryOptions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HistoryOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'luci.resultdb.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HistoryOptions copyWith(void Function(HistoryOptions) updates) => super.copyWith((message) => updates(message as HistoryOptions)) as HistoryOptions;
...
class SourceSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SourceSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'luci.resultdb.v1'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(1)
  set sources(Sources v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class Sources extends $pb.GeneratedMessage {
  ...
  Sources._() : super();
  factory Sources.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Sources.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Sources', package: const $pb.PackageName(_omitMessageNames ? '' : 'luci.resultdb.v1'), createEmptyInstance: create)
    ..aOM<$1.GitilesCommit>(1, _omitFieldNames ? '' : 'gitilesCommit', subBuilder: $1.GitilesCommit.create)
    ..pc<$1.GerritChange>(2, _omitFieldNames ? '' : 'changelists', $pb.PbFieldType.PM, subBuilder: $1.GerritChange.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Sources copyWith(void Function(Sources) updates) => super.copyWith((message) => updates(message as Sources)) as Sources;
  ...
  @$pb.TagNumber(1)
  set gitilesCommit($1.GitilesCommit v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set isDirty($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
