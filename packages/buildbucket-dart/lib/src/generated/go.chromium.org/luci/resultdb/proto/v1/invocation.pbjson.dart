...
const Invocation$json = {
  ...
  '2': [
    ...
    {'1': 'state', '3': 2, '4': 1, '5': 14, '6': '.luci.resultdb.v1.Invocation.State', '10': 'state'},
    {'1': 'create_time', '3': 4, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': {}, '10': 'createTime'},
    {'1': 'tags', '3': 5, '4': 3, '5': 11, '6': '.luci.resultdb.v1.StringPair', '10': 'tags'},
    {'1': 'finalize_time', '3': 6, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': {}, '10': 'finalizeTime'},
    {'1': 'deadline', '3': 7, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'deadline'},
    {'1': 'included_invocations', '3': 8, '4': 3, '5': 9, '10': 'includedInvocations'},
    {
      '1': 'bigquery_exports',
      '3': 9,
      '4': 3,
    ...
    {'1': 'producer_resource', '3': 11, '4': 1, '5': 9, '10': 'producerResource'},
    {'1': 'realm', '3': 12, '4': 1, '5': 9, '10': 'realm'},
    {'1': 'history_options', '3': 13, '4': 1, '5': 11, '6': '.luci.resultdb.v1.HistoryOptions', '10': 'historyOptions'},
    {'1': 'properties', '3': 14, '4': 1, '5': 11, '6': '.google.protobuf.Struct', '10': 'properties'},
    {'1': 'source_spec', '3': 15, '4': 1, '5': 11, '6': '.luci.resultdb.v1.SourceSpec', '10': 'sourceSpec'},
...
final $typed_data.Uint8List invocationDescriptor =
    $convert.base64Decode('CgpJbnZvY2F0aW9uEhoKBG5hbWUYASABKAlCBuBBA+BBBVIEbmFtZRI4CgVzdGF0ZRgCIAEoDj'
...
const BigQueryExport_TestResults$json = {
  '1': 'TestResults',
  '2': [
    {'1': 'predicate', '3': 1, '4': 1, '5': 11, '6': '.luci.resultdb.v1.TestResultPredicate', '10': 'predicate'},
  ],
};
...
const BigQueryExport_TextArtifacts$json = {
  '1': 'TextArtifacts',
  '2': [
    {'1': 'predicate', '3': 1, '4': 1, '5': 11, '6': '.luci.resultdb.v1.ArtifactPredicate', '10': 'predicate'},
  ],
};

/// Descriptor for `BigQueryExport`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List bigQueryExportDescriptor =
    $convert.base64Decode('Cg5CaWdRdWVyeUV4cG9ydBIdCgdwcm9qZWN0GAEgASgJQgPgQQJSB3Byb2plY3QSHQoHZGF0YX'
...
const HistoryOptions$json = {
  '1': 'HistoryOptions',
  '2': [
    {'1': 'use_invocation_timestamp', '3': 1, '4': 1, '5': 8, '10': 'useInvocationTimestamp'},
    {'1': 'commit', '3': 2, '4': 1, '5': 11, '6': '.luci.resultdb.v1.CommitPosition', '10': 'commit'},
  ],
};

/// Descriptor for `HistoryOptions`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List historyOptionsDescriptor =
    $convert.base64Decode('Cg5IaXN0b3J5T3B0aW9ucxI4Chh1c2VfaW52b2NhdGlvbl90aW1lc3RhbXAYASABKAhSFnVzZU'
...
const SourceSpec$json = {
  '1': 'SourceSpec',
  '2': [
    {'1': 'sources', '3': 1, '4': 1, '5': 11, '6': '.luci.resultdb.v1.Sources', '10': 'sources'},
    {'1': 'inherit', '3': 2, '4': 1, '5': 8, '10': 'inherit'},
  ],
};

/// Descriptor for `SourceSpec`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sourceSpecDescriptor =
    $convert.base64Decode('CgpTb3VyY2VTcGVjEjMKB3NvdXJjZXMYASABKAsyGS5sdWNpLnJlc3VsdGRiLnYxLlNvdXJjZX'
...
const Sources$json = {
  '1': 'Sources',
  '2': [
    {'1': 'gitiles_commit', '3': 1, '4': 1, '5': 11, '6': '.luci.resultdb.v1.GitilesCommit', '10': 'gitilesCommit'},
    {'1': 'changelists', '3': 2, '4': 3, '5': 11, '6': '.luci.resultdb.v1.GerritChange', '10': 'changelists'},
    {'1': 'is_dirty', '3': 3, '4': 1, '5': 8, '10': 'isDirty'},
  ],
};

/// Descriptor for `Sources`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sourcesDescriptor =
    $convert.base64Decode('CgdTb3VyY2VzEkYKDmdpdGlsZXNfY29tbWl0GAEgASgLMh8ubHVjaS5yZXN1bHRkYi52MS5HaX'
