...
class ReportTestResultsRequest extends $pb.GeneratedMessage {
  ...
  factory ReportTestResultsRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ReportTestResultsRequest',
      package:
  ...
  ReportTestResultsRequest clone() =>
      ReportTestResultsRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ReportTestResultsRequest copyWith(
          void Function(ReportTestResultsRequest) updates) =>
      super.copyWith((message) => updates(message as ReportTestResultsRequest))
          as ReportTestResultsRequest;
  ...
  static $pb.PbList<ReportTestResultsRequest> createRepeated() =>
      $pb.PbList<ReportTestResultsRequest>();
  @$core.pragma('dart2js:noInline')
  static ReportTestResultsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ReportTestResultsRequest>(create);
...
class ReportTestResultsResponse extends $pb.GeneratedMessage {
  ...
  factory ReportTestResultsResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ReportTestResultsResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ReportTestResultsResponse',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'luci.resultsink.v1'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ReportTestResultsResponse clone() =>
      ReportTestResultsResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ReportTestResultsResponse copyWith(
          void Function(ReportTestResultsResponse) updates) =>
      super.copyWith((message) => updates(message as ReportTestResultsResponse))
          as ReportTestResultsResponse;
  ...
  static $pb.PbList<ReportTestResultsResponse> createRepeated() =>
      $pb.PbList<ReportTestResultsResponse>();
  @$core.pragma('dart2js:noInline')
  static ReportTestResultsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ReportTestResultsResponse>(create);
...
class ReportInvocationLevelArtifactsRequest extends $pb.GeneratedMessage {
  ...
  factory ReportInvocationLevelArtifactsRequest.fromBuffer(
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ReportInvocationLevelArtifactsRequest',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'luci.resultsink.v1'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ReportInvocationLevelArtifactsRequest clone() =>
      ReportInvocationLevelArtifactsRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ReportInvocationLevelArtifactsRequest copyWith(
          void Function(ReportInvocationLevelArtifactsRequest) updates) =>
      super.copyWith((message) =>
              updates(message as ReportInvocationLevelArtifactsRequest))
          as ReportInvocationLevelArtifactsRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ReportInvocationLevelArtifactsRequest create() =>
      ReportInvocationLevelArtifactsRequest._();
  ...
  static ReportInvocationLevelArtifactsRequest getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          ReportInvocationLevelArtifactsRequest>(create);
