...
class BuildInfra_Buildbucket_ExperimentReason extends $pb.ProtobufEnum {
  static const BuildInfra_Buildbucket_ExperimentReason EXPERIMENT_REASON_UNSET =
      BuildInfra_Buildbucket_ExperimentReason._(0, _omitEnumNames ? '' : 'EXPERIMENT_REASON_UNSET');
  static const BuildInfra_Buildbucket_ExperimentReason EXPERIMENT_REASON_GLOBAL_DEFAULT =
      BuildInfra_Buildbucket_ExperimentReason._(1, _omitEnumNames ? '' : 'EXPERIMENT_REASON_GLOBAL_DEFAULT');
  static const BuildInfra_Buildbucket_ExperimentReason EXPERIMENT_REASON_BUILDER_CONFIG =
      BuildInfra_Buildbucket_ExperimentReason._(2, _omitEnumNames ? '' : 'EXPERIMENT_REASON_BUILDER_CONFIG');
  static const BuildInfra_Buildbucket_ExperimentReason EXPERIMENT_REASON_GLOBAL_MINIMUM =
      BuildInfra_Buildbucket_ExperimentReason._(3, _omitEnumNames ? '' : 'EXPERIMENT_REASON_GLOBAL_MINIMUM');
  static const BuildInfra_Buildbucket_ExperimentReason EXPERIMENT_REASON_REQUESTED =
      BuildInfra_Buildbucket_ExperimentReason._(4, _omitEnumNames ? '' : 'EXPERIMENT_REASON_REQUESTED');
  static const BuildInfra_Buildbucket_ExperimentReason EXPERIMENT_REASON_GLOBAL_INACTIVE =
      BuildInfra_Buildbucket_ExperimentReason._(5, _omitEnumNames ? '' : 'EXPERIMENT_REASON_GLOBAL_INACTIVE');
...
class BuildInfra_Buildbucket_Agent_Purpose extends $pb.ProtobufEnum {
  static const BuildInfra_Buildbucket_Agent_Purpose PURPOSE_UNSPECIFIED =
      BuildInfra_Buildbucket_Agent_Purpose._(0, _omitEnumNames ? '' : 'PURPOSE_UNSPECIFIED');
  static const BuildInfra_Buildbucket_Agent_Purpose PURPOSE_EXE_PAYLOAD =
      BuildInfra_Buildbucket_Agent_Purpose._(1, _omitEnumNames ? '' : 'PURPOSE_EXE_PAYLOAD');
  static const BuildInfra_Buildbucket_Agent_Purpose PURPOSE_BBAGENT_UTILITY =
      BuildInfra_Buildbucket_Agent_Purpose._(2, _omitEnumNames ? '' : 'PURPOSE_BBAGENT_UTILITY');
