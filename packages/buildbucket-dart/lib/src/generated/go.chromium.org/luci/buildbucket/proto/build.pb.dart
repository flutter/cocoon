...
class Build_Input extends $pb.GeneratedMessage {
  ...
  Build_Input._() : super();
  factory Build_Input.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Build_Input.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Build.Input',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..aOM<$5.Struct>(1, _omitFieldNames ? '' : 'properties',
        subBuilder: $5.Struct.create)
    ..aOM<$3.GitilesCommit>(2, _omitFieldNames ? '' : 'gitilesCommit',
  ...
  Build_Input copyWith(void Function(Build_Input) updates) =>
      super.copyWith((message) => updates(message as Build_Input))
          as Build_Input;
  ...
  @$core.pragma('dart2js:noInline')
  static Build_Input getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Build_Input>(create);
...
class Build_Output extends $pb.GeneratedMessage {
  ...
  factory Build_Output.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Build_Output.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Build.Output',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..aOM<$5.Struct>(1, _omitFieldNames ? '' : 'properties',
        subBuilder: $5.Struct.create)
    ..aOS(2, _omitFieldNames ? '' : 'summaryMarkdown')
    ..aOM<$3.GitilesCommit>(3, _omitFieldNames ? '' : 'gitilesCommit',
        subBuilder: $3.GitilesCommit.create)
    ..pc<$3.Log>(5, _omitFieldNames ? '' : 'logs', $pb.PbFieldType.PM,
        subBuilder: $3.Log.create)
    ..e<$3.Status>(6, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE,
        defaultOrMaker: $3.Status.STATUS_UNSPECIFIED,
        valueOf: $3.Status.valueOf,
        enumValues: $3.Status.values)
    ..aOM<$3.StatusDetails>(7, _omitFieldNames ? '' : 'statusDetails',
  ...
  Build_Output copyWith(void Function(Build_Output) updates) =>
      super.copyWith((message) => updates(message as Build_Output))
          as Build_Output;
  ...
  static $pb.PbList<Build_Output> createRepeated() =>
      $pb.PbList<Build_Output>();
  @$core.pragma('dart2js:noInline')
  static Build_Output getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Build_Output>(create);
...
class Build_BuilderInfo extends $pb.GeneratedMessage {
  ...
  factory Build_BuilderInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Build_BuilderInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Build.BuilderInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
  ...
  Build_BuilderInfo copyWith(void Function(Build_BuilderInfo) updates) =>
      super.copyWith((message) => updates(message as Build_BuilderInfo))
          as Build_BuilderInfo;
  ...
  static $pb.PbList<Build_BuilderInfo> createRepeated() =>
      $pb.PbList<Build_BuilderInfo>();
  @$core.pragma('dart2js:noInline')
  static Build_BuilderInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Build_BuilderInfo>(create);
...
class Build extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.BuilderID>(2, _omitFieldNames ? '' : 'builder',
    ...
    ..aOM<$1.Timestamp>(7, _omitFieldNames ? '' : 'startTime',
        subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(8, _omitFieldNames ? '' : 'endTime',
        subBuilder: $1.Timestamp.create)
    ...
    ..e<$3.Status>(12, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE,
        ...
        valueOf: $3.Status.valueOf,
        enumValues: $3.Status.values)
    ..aOM<Build_Input>(15, _omitFieldNames ? '' : 'input',
        subBuilder: Build_Input.create)
    ..aOM<Build_Output>(16, _omitFieldNames ? '' : 'output',
        subBuilder: Build_Output.create)
    ..pc<$2.Step>(17, _omitFieldNames ? '' : 'steps', $pb.PbFieldType.PM,
        subBuilder: $2.Step.create)
    ..aOM<BuildInfra>(18, _omitFieldNames ? '' : 'infra',
        subBuilder: BuildInfra.create)
    ..pc<$3.StringPair>(19, _omitFieldNames ? '' : 'tags', $pb.PbFieldType.PM,
    ...
    ..e<$3.Trinary>(21, _omitFieldNames ? '' : 'critical', $pb.PbFieldType.OE,
        defaultOrMaker: $3.Trinary.UNSET,
        valueOf: $3.Trinary.valueOf,
        enumValues: $3.Trinary.values)
    ..aOM<$3.StatusDetails>(22, _omitFieldNames ? '' : 'statusDetails',
        subBuilder: $3.StatusDetails.create)
    ..aOS(23, _omitFieldNames ? '' : 'canceledBy')
    ..aOM<$3.Executable>(24, _omitFieldNames ? '' : 'exe',
        subBuilder: $3.Executable.create)
    ..aOB(25, _omitFieldNames ? '' : 'canary')
    ..aOM<$4.Duration>(26, _omitFieldNames ? '' : 'schedulingTimeout',
        subBuilder: $4.Duration.create)
    ..aOM<$4.Duration>(27, _omitFieldNames ? '' : 'executionTimeout',
        subBuilder: $4.Duration.create)
    ..aOB(28, _omitFieldNames ? '' : 'waitForCapacity')
    ..aOM<$4.Duration>(29, _omitFieldNames ? '' : 'gracePeriod',
        subBuilder: $4.Duration.create)
    ..aOB(30, _omitFieldNames ? '' : 'canOutliveParent')
    ..p<$fixnum.Int64>(
        31, _omitFieldNames ? '' : 'ancestorIds', $pb.PbFieldType.K6)
    ..aOM<$1.Timestamp>(32, _omitFieldNames ? '' : 'cancelTime',
        subBuilder: $1.Timestamp.create)
    ..aOS(33, _omitFieldNames ? '' : 'cancellationMarkdown')
    ..aOM<Build_BuilderInfo>(34, _omitFieldNames ? '' : 'builderInfo',
        subBuilder: Build_BuilderInfo.create)
...
class InputDataRef_CAS_Digest extends $pb.GeneratedMessage {
  ...
  factory InputDataRef_CAS_Digest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory InputDataRef_CAS_Digest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'InputDataRef.CAS.Digest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  InputDataRef_CAS_Digest clone() =>
      InputDataRef_CAS_Digest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  InputDataRef_CAS_Digest copyWith(
          void Function(InputDataRef_CAS_Digest) updates) =>
      super.copyWith((message) => updates(message as InputDataRef_CAS_Digest))
          as InputDataRef_CAS_Digest;
  ...
  static $pb.PbList<InputDataRef_CAS_Digest> createRepeated() =>
      $pb.PbList<InputDataRef_CAS_Digest>();
  @$core.pragma('dart2js:noInline')
  static InputDataRef_CAS_Digest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InputDataRef_CAS_Digest>(create);
...
class InputDataRef_CAS extends $pb.GeneratedMessage {
  ...
  factory InputDataRef_CAS.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory InputDataRef_CAS.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'InputDataRef.CAS',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'casInstance')
    ..aOM<InputDataRef_CAS_Digest>(2, _omitFieldNames ? '' : 'digest',
  ...
  static $pb.PbList<InputDataRef_CAS> createRepeated() =>
      $pb.PbList<InputDataRef_CAS>();
  @$core.pragma('dart2js:noInline')
  static InputDataRef_CAS getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InputDataRef_CAS>(create);
...
class InputDataRef_CIPD_PkgSpec extends $pb.GeneratedMessage {
  ...
  factory InputDataRef_CIPD_PkgSpec.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory InputDataRef_CIPD_PkgSpec.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'InputDataRef.CIPD.PkgSpec',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  InputDataRef_CIPD_PkgSpec clone() =>
      InputDataRef_CIPD_PkgSpec()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  InputDataRef_CIPD_PkgSpec copyWith(
          void Function(InputDataRef_CIPD_PkgSpec) updates) =>
  ...
  static $pb.PbList<InputDataRef_CIPD_PkgSpec> createRepeated() =>
      $pb.PbList<InputDataRef_CIPD_PkgSpec>();
  @$core.pragma('dart2js:noInline')
  static InputDataRef_CIPD_PkgSpec getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InputDataRef_CIPD_PkgSpec>(create);
...
class InputDataRef_CIPD extends $pb.GeneratedMessage {
  ...
  factory InputDataRef_CIPD.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory InputDataRef_CIPD.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'InputDataRef.CIPD',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'server')
    ..pc<InputDataRef_CIPD_PkgSpec>(
        2, _omitFieldNames ? '' : 'specs', $pb.PbFieldType.PM,
  ...
  static $pb.PbList<InputDataRef_CIPD> createRepeated() =>
      $pb.PbList<InputDataRef_CIPD>();
  @$core.pragma('dart2js:noInline')
  static InputDataRef_CIPD getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InputDataRef_CIPD>(create);
...
class InputDataRef extends $pb.GeneratedMessage {
  ...
  factory InputDataRef.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory InputDataRef.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, InputDataRef_DataType>
      _InputDataRef_DataTypeByTag = {
    1: InputDataRef_DataType.cas,
    2: InputDataRef_DataType.cipd,
    0: InputDataRef_DataType.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'InputDataRef',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<InputDataRef_CAS>(1, _omitFieldNames ? '' : 'cas',
        subBuilder: InputDataRef_CAS.create)
    ..aOM<InputDataRef_CIPD>(2, _omitFieldNames ? '' : 'cipd',
  ...
  InputDataRef copyWith(void Function(InputDataRef) updates) =>
      super.copyWith((message) => updates(message as InputDataRef))
          as InputDataRef;
  ...
  static $pb.PbList<InputDataRef> createRepeated() =>
      $pb.PbList<InputDataRef>();
  @$core.pragma('dart2js:noInline')
  static InputDataRef getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InputDataRef>(create);
  static InputDataRef? _defaultInstance;

  InputDataRef_DataType whichDataType() =>
      _InputDataRef_DataTypeByTag[$_whichOneof(0)]!;
...
class ResolvedDataRef_Timing extends $pb.GeneratedMessage {
  ...
  factory ResolvedDataRef_Timing.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ResolvedDataRef_Timing.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ResolvedDataRef.Timing',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..aOM<$4.Duration>(1, _omitFieldNames ? '' : 'fetchDuration',
        subBuilder: $4.Duration.create)
    ..aOM<$4.Duration>(2, _omitFieldNames ? '' : 'installDuration',
        subBuilder: $4.Duration.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ResolvedDataRef_Timing clone() =>
      ResolvedDataRef_Timing()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ResolvedDataRef_Timing copyWith(
          void Function(ResolvedDataRef_Timing) updates) =>
  ...
  static $pb.PbList<ResolvedDataRef_Timing> createRepeated() =>
      $pb.PbList<ResolvedDataRef_Timing>();
  @$core.pragma('dart2js:noInline')
  static ResolvedDataRef_Timing getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ResolvedDataRef_Timing>(create);
...
class ResolvedDataRef_CAS extends $pb.GeneratedMessage {
  ...
  factory ResolvedDataRef_CAS.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ResolvedDataRef_CAS.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ResolvedDataRef.CAS',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..aOM<ResolvedDataRef_Timing>(1, _omitFieldNames ? '' : 'timing',
  ...
  static $pb.PbList<ResolvedDataRef_CAS> createRepeated() =>
      $pb.PbList<ResolvedDataRef_CAS>();
  @$core.pragma('dart2js:noInline')
  static ResolvedDataRef_CAS getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ResolvedDataRef_CAS>(create);
...
class ResolvedDataRef_CIPD_PkgSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ResolvedDataRef.CIPD.PkgSpec',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ...
    ..e<$3.Trinary>(4, _omitFieldNames ? '' : 'wasCached', $pb.PbFieldType.OE,
        ...
        valueOf: $3.Trinary.valueOf,
        enumValues: $3.Trinary.values)
    ..aOM<ResolvedDataRef_Timing>(5, _omitFieldNames ? '' : 'timing',
        subBuilder: ResolvedDataRef_Timing.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ResolvedDataRef_CIPD_PkgSpec clone() =>
      ResolvedDataRef_CIPD_PkgSpec()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ResolvedDataRef_CIPD_PkgSpec copyWith(
          void Function(ResolvedDataRef_CIPD_PkgSpec) updates) =>
      super.copyWith(
              (message) => updates(message as ResolvedDataRef_CIPD_PkgSpec))
          as ResolvedDataRef_CIPD_PkgSpec;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ResolvedDataRef_CIPD_PkgSpec create() =>
      ResolvedDataRef_CIPD_PkgSpec._();
  ResolvedDataRef_CIPD_PkgSpec createEmptyInstance() => create();
  static $pb.PbList<ResolvedDataRef_CIPD_PkgSpec> createRepeated() =>
      $pb.PbList<ResolvedDataRef_CIPD_PkgSpec>();
  @$core.pragma('dart2js:noInline')
  static ResolvedDataRef_CIPD_PkgSpec getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ResolvedDataRef_CIPD_PkgSpec>(create);
...
class ResolvedDataRef_CIPD extends $pb.GeneratedMessage {
  ...
  factory ResolvedDataRef_CIPD.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ResolvedDataRef_CIPD.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ResolvedDataRef.CIPD',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ResolvedDataRef_CIPD clone() =>
      ResolvedDataRef_CIPD()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ...
  static $pb.PbList<ResolvedDataRef_CIPD> createRepeated() =>
      $pb.PbList<ResolvedDataRef_CIPD>();
  @$core.pragma('dart2js:noInline')
  static ResolvedDataRef_CIPD getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ResolvedDataRef_CIPD>(create);
...
class ResolvedDataRef extends $pb.GeneratedMessage {
  ...
  factory ResolvedDataRef.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ResolvedDataRef.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, ResolvedDataRef_DataType>
      _ResolvedDataRef_DataTypeByTag = {
    1: ResolvedDataRef_DataType.cas,
    2: ResolvedDataRef_DataType.cipd,
    0: ResolvedDataRef_DataType.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ResolvedDataRef',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<ResolvedDataRef_CAS>(1, _omitFieldNames ? '' : 'cas',
        subBuilder: ResolvedDataRef_CAS.create)
    ..aOM<ResolvedDataRef_CIPD>(2, _omitFieldNames ? '' : 'cipd',
  ...
  static $pb.PbList<ResolvedDataRef> createRepeated() =>
      $pb.PbList<ResolvedDataRef>();
  @$core.pragma('dart2js:noInline')
  static ResolvedDataRef getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ResolvedDataRef>(create);
  static ResolvedDataRef? _defaultInstance;

  ResolvedDataRef_DataType whichDataType() =>
      _ResolvedDataRef_DataTypeByTag[$_whichOneof(0)]!;
  void clearDataType() => clearField($_whichOneof(0));
...
class BuildInfra_Buildbucket_Agent_Source_CIPD extends $pb.GeneratedMessage {
  ...
  factory BuildInfra_Buildbucket_Agent_Source_CIPD.fromBuffer(
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BuildInfra.Buildbucket.Agent.Source.CIPD',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'package')
    ..aOS(2, _omitFieldNames ? '' : 'version')
    ...
    ..m<$core.String, $core.String>(
        4, _omitFieldNames ? '' : 'resolvedInstances',
        entryClassName:
            'BuildInfra.Buildbucket.Agent.Source.CIPD.ResolvedInstancesEntry',
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BuildInfra_Buildbucket_Agent_Source_CIPD copyWith(
          void Function(BuildInfra_Buildbucket_Agent_Source_CIPD) updates) =>
      super.copyWith((message) =>
              updates(message as BuildInfra_Buildbucket_Agent_Source_CIPD))
          as BuildInfra_Buildbucket_Agent_Source_CIPD;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static BuildInfra_Buildbucket_Agent_Source_CIPD create() =>
      BuildInfra_Buildbucket_Agent_Source_CIPD._();
  BuildInfra_Buildbucket_Agent_Source_CIPD createEmptyInstance() => create();
  static $pb.PbList<BuildInfra_Buildbucket_Agent_Source_CIPD>
      createRepeated() =>
          $pb.PbList<BuildInfra_Buildbucket_Agent_Source_CIPD>();
  @$core.pragma('dart2js:noInline')
  static BuildInfra_Buildbucket_Agent_Source_CIPD getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          BuildInfra_Buildbucket_Agent_Source_CIPD>(create);
...
class BuildInfra_Buildbucket_Agent_Source extends $pb.GeneratedMessage {
  ...
  factory BuildInfra_Buildbucket_Agent_Source.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  ...
  static const $core
      .Map<$core.int, BuildInfra_Buildbucket_Agent_Source_DataType>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BuildInfra.Buildbucket.Agent.Source',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<BuildInfra_Buildbucket_Agent_Source_CIPD>(
        1, _omitFieldNames ? '' : 'cipd',
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  BuildInfra_Buildbucket_Agent_Source clone() =>
      BuildInfra_Buildbucket_Agent_Source()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BuildInfra_Buildbucket_Agent_Source copyWith(
          void Function(BuildInfra_Buildbucket_Agent_Source) updates) =>
      super.copyWith((message) =>
              updates(message as BuildInfra_Buildbucket_Agent_Source))
          as BuildInfra_Buildbucket_Agent_Source;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static BuildInfra_Buildbucket_Agent_Source create() =>
      BuildInfra_Buildbucket_Agent_Source._();
  ...
  static BuildInfra_Buildbucket_Agent_Source getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          BuildInfra_Buildbucket_Agent_Source>(create);
...
class BuildInfra_Buildbucket_Agent_Input extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BuildInfra.Buildbucket.Agent.Input',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  BuildInfra_Buildbucket_Agent_Input clone() =>
      BuildInfra_Buildbucket_Agent_Input()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BuildInfra_Buildbucket_Agent_Input copyWith(
          void Function(BuildInfra_Buildbucket_Agent_Input) updates) =>
      super.copyWith((message) =>
              updates(message as BuildInfra_Buildbucket_Agent_Input))
          as BuildInfra_Buildbucket_Agent_Input;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static BuildInfra_Buildbucket_Agent_Input create() =>
      BuildInfra_Buildbucket_Agent_Input._();
  ...
  @$core.pragma('dart2js:noInline')
  static BuildInfra_Buildbucket_Agent_Input getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BuildInfra_Buildbucket_Agent_Input>(
          create);
...
class BuildInfra_Buildbucket_Agent_Output extends $pb.GeneratedMessage {
  ...
  factory BuildInfra_Buildbucket_Agent_Output.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BuildInfra.Buildbucket.Agent.Output',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ...
    ..e<$3.Status>(2, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE,
        ...
        valueOf: $3.Status.valueOf,
        enumValues: $3.Status.values)
    ..aOM<$3.StatusDetails>(3, _omitFieldNames ? '' : 'statusDetails',
        subBuilder: $3.StatusDetails.create)
    ..aOS(4, _omitFieldNames ? '' : 'summaryHtml')
    ..aOS(5, _omitFieldNames ? '' : 'agentPlatform')
    ..aOM<$4.Duration>(6, _omitFieldNames ? '' : 'totalDuration',
        subBuilder: $4.Duration.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  BuildInfra_Buildbucket_Agent_Output clone() =>
      BuildInfra_Buildbucket_Agent_Output()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BuildInfra_Buildbucket_Agent_Output copyWith(
          void Function(BuildInfra_Buildbucket_Agent_Output) updates) =>
      super.copyWith((message) =>
              updates(message as BuildInfra_Buildbucket_Agent_Output))
          as BuildInfra_Buildbucket_Agent_Output;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static BuildInfra_Buildbucket_Agent_Output create() =>
      BuildInfra_Buildbucket_Agent_Output._();
  ...
  static BuildInfra_Buildbucket_Agent_Output getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          BuildInfra_Buildbucket_Agent_Output>(create);
...
class BuildInfra_Buildbucket_Agent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BuildInfra.Buildbucket.Agent',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ...
    ..m<$core.String, BuildInfra_Buildbucket_Agent_Purpose>(
        ...
        valueDefaultOrMaker:
            BuildInfra_Buildbucket_Agent_Purpose.PURPOSE_UNSPECIFIED,
        defaultEnumValue:
            BuildInfra_Buildbucket_Agent_Purpose.PURPOSE_UNSPECIFIED,
        packageName: const $pb.PackageName('buildbucket.v2'))
    ..aOM<$3.CacheEntry>(5, _omitFieldNames ? '' : 'cipdClientCache',
        subBuilder: $3.CacheEntry.create)
    ..aOM<$3.CacheEntry>(6, _omitFieldNames ? '' : 'cipdPackagesCache',
        subBuilder: $3.CacheEntry.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  BuildInfra_Buildbucket_Agent clone() =>
      BuildInfra_Buildbucket_Agent()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BuildInfra_Buildbucket_Agent copyWith(
          void Function(BuildInfra_Buildbucket_Agent) updates) =>
      super.copyWith(
              (message) => updates(message as BuildInfra_Buildbucket_Agent))
          as BuildInfra_Buildbucket_Agent;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static BuildInfra_Buildbucket_Agent create() =>
      BuildInfra_Buildbucket_Agent._();
  BuildInfra_Buildbucket_Agent createEmptyInstance() => create();
  static $pb.PbList<BuildInfra_Buildbucket_Agent> createRepeated() =>
      $pb.PbList<BuildInfra_Buildbucket_Agent>();
  @$core.pragma('dart2js:noInline')
  static BuildInfra_Buildbucket_Agent getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BuildInfra_Buildbucket_Agent>(create);
  ...
  @$pb.TagNumber(4)
  $core.Map<$core.String, BuildInfra_Buildbucket_Agent_Purpose> get purposes =>
      $_getMap(3);
...
class BuildInfra_Buildbucket extends $pb.GeneratedMessage {
  factory BuildInfra_Buildbucket({
    ...
    $core.Map<$core.String, BuildInfra_Buildbucket_ExperimentReason>?
        experimentReasons,
    @$core.Deprecated('This field is deprecated.')
  ...
  factory BuildInfra_Buildbucket.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BuildInfra_Buildbucket.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BuildInfra.Buildbucket',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..aOS(2, _omitFieldNames ? '' : 'serviceConfigRevision')
    ..aOM<$5.Struct>(5, _omitFieldNames ? '' : 'requestedProperties',
        subBuilder: $5.Struct.create)
    ..pc<$3.RequestedDimension>(
        6, _omitFieldNames ? '' : 'requestedDimensions', $pb.PbFieldType.PM,
    ...
    ..m<$core.String, BuildInfra_Buildbucket_ExperimentReason>(
        8, _omitFieldNames ? '' : 'experimentReasons',
        ...
        valueDefaultOrMaker:
            BuildInfra_Buildbucket_ExperimentReason.EXPERIMENT_REASON_UNSET,
        defaultEnumValue:
            BuildInfra_Buildbucket_ExperimentReason.EXPERIMENT_REASON_UNSET,
        packageName: const $pb.PackageName('buildbucket.v2'))
    ..m<$core.String, ResolvedDataRef>(
        9, _omitFieldNames ? '' : 'agentExecutable',
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  BuildInfra_Buildbucket clone() =>
      BuildInfra_Buildbucket()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BuildInfra_Buildbucket copyWith(
          void Function(BuildInfra_Buildbucket) updates) =>
  ...
  static $pb.PbList<BuildInfra_Buildbucket> createRepeated() =>
      $pb.PbList<BuildInfra_Buildbucket>();
  @$core.pragma('dart2js:noInline')
  static BuildInfra_Buildbucket getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BuildInfra_Buildbucket>(create);
  ...
  @$pb.TagNumber(8)
  $core.Map<$core.String, BuildInfra_Buildbucket_ExperimentReason>
      get experimentReasons => $_getMap(4);
...
class BuildInfra_Swarming_CacheEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BuildInfra.Swarming.CacheEntry',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'path')
    ..aOM<$4.Duration>(3, _omitFieldNames ? '' : 'waitForWarmCache',
        subBuilder: $4.Duration.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  BuildInfra_Swarming_CacheEntry clone() =>
      BuildInfra_Swarming_CacheEntry()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BuildInfra_Swarming_CacheEntry copyWith(
          void Function(BuildInfra_Swarming_CacheEntry) updates) =>
      super.copyWith(
              (message) => updates(message as BuildInfra_Swarming_CacheEntry))
          as BuildInfra_Swarming_CacheEntry;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static BuildInfra_Swarming_CacheEntry create() =>
      BuildInfra_Swarming_CacheEntry._();
  BuildInfra_Swarming_CacheEntry createEmptyInstance() => create();
  static $pb.PbList<BuildInfra_Swarming_CacheEntry> createRepeated() =>
      $pb.PbList<BuildInfra_Swarming_CacheEntry>();
  @$core.pragma('dart2js:noInline')
  static BuildInfra_Swarming_CacheEntry getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BuildInfra_Swarming_CacheEntry>(create);
...
class BuildInfra_Swarming extends $pb.GeneratedMessage {
  ...
  factory BuildInfra_Swarming.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BuildInfra_Swarming.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BuildInfra.Swarming',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ...
    ..pc<$3.RequestedDimension>(
        5, _omitFieldNames ? '' : 'taskDimensions', $pb.PbFieldType.PM,
        subBuilder: $3.RequestedDimension.create)
    ..pc<$3.StringPair>(
        6, _omitFieldNames ? '' : 'botDimensions', $pb.PbFieldType.PM,
        subBuilder: $3.StringPair.create)
    ..pc<BuildInfra_Swarming_CacheEntry>(
        7, _omitFieldNames ? '' : 'caches', $pb.PbFieldType.PM,
  ...
  static $pb.PbList<BuildInfra_Swarming> createRepeated() =>
      $pb.PbList<BuildInfra_Swarming>();
  @$core.pragma('dart2js:noInline')
  static BuildInfra_Swarming getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BuildInfra_Swarming>(create);
...
class BuildInfra_LogDog extends $pb.GeneratedMessage {
  ...
  factory BuildInfra_LogDog.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BuildInfra_LogDog.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BuildInfra.LogDog',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'hostname')
  ...
  static $pb.PbList<BuildInfra_LogDog> createRepeated() =>
      $pb.PbList<BuildInfra_LogDog>();
  @$core.pragma('dart2js:noInline')
  static BuildInfra_LogDog getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BuildInfra_LogDog>(create);
...
class BuildInfra_Recipe extends $pb.GeneratedMessage {
  ...
  factory BuildInfra_Recipe.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BuildInfra_Recipe.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BuildInfra.Recipe',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
  ...
  static $pb.PbList<BuildInfra_Recipe> createRepeated() =>
      $pb.PbList<BuildInfra_Recipe>();
  @$core.pragma('dart2js:noInline')
  static BuildInfra_Recipe getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BuildInfra_Recipe>(create);
...
class BuildInfra_ResultDB extends $pb.GeneratedMessage {
  ...
  factory BuildInfra_ResultDB.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BuildInfra_ResultDB.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BuildInfra.ResultDB',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'hostname')
    ...
    ..pc<$6.BigQueryExport>(
        4, _omitFieldNames ? '' : 'bqExports', $pb.PbFieldType.PM,
        subBuilder: $6.BigQueryExport.create)
    ..aOM<$6.HistoryOptions>(5, _omitFieldNames ? '' : 'historyOptions',
        subBuilder: $6.HistoryOptions.create)
    ..hasRequiredFields = false;
  ...
  static $pb.PbList<BuildInfra_ResultDB> createRepeated() =>
      $pb.PbList<BuildInfra_ResultDB>();
  @$core.pragma('dart2js:noInline')
  static BuildInfra_ResultDB getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BuildInfra_ResultDB>(create);
...
class BuildInfra_Led extends $pb.GeneratedMessage {
  ...
  factory BuildInfra_Led.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BuildInfra_Led.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BuildInfra.Led',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
  ...
  BuildInfra_Led copyWith(void Function(BuildInfra_Led) updates) =>
      super.copyWith((message) => updates(message as BuildInfra_Led))
          as BuildInfra_Led;
  ...
  static $pb.PbList<BuildInfra_Led> createRepeated() =>
      $pb.PbList<BuildInfra_Led>();
  @$core.pragma('dart2js:noInline')
  static BuildInfra_Led getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BuildInfra_Led>(create);
...
class BuildInfra_BBAgent_Input_CIPDPackage extends $pb.GeneratedMessage {
  ...
  factory BuildInfra_BBAgent_Input_CIPDPackage.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BuildInfra.BBAgent.Input.CIPDPackage',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'version')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  BuildInfra_BBAgent_Input_CIPDPackage clone() =>
      BuildInfra_BBAgent_Input_CIPDPackage()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BuildInfra_BBAgent_Input_CIPDPackage copyWith(
          void Function(BuildInfra_BBAgent_Input_CIPDPackage) updates) =>
      super.copyWith((message) =>
              updates(message as BuildInfra_BBAgent_Input_CIPDPackage))
          as BuildInfra_BBAgent_Input_CIPDPackage;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static BuildInfra_BBAgent_Input_CIPDPackage create() =>
      BuildInfra_BBAgent_Input_CIPDPackage._();
  ...
  static BuildInfra_BBAgent_Input_CIPDPackage getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          BuildInfra_BBAgent_Input_CIPDPackage>(create);
...
class BuildInfra_BBAgent_Input extends $pb.GeneratedMessage {
  ...
  factory BuildInfra_BBAgent_Input.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BuildInfra_BBAgent_Input.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BuildInfra.BBAgent.Input',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..pc<BuildInfra_BBAgent_Input_CIPDPackage>(
        1, _omitFieldNames ? '' : 'cipdPackages', $pb.PbFieldType.PM,
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  BuildInfra_BBAgent_Input clone() =>
      BuildInfra_BBAgent_Input()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BuildInfra_BBAgent_Input copyWith(
          void Function(BuildInfra_BBAgent_Input) updates) =>
  ...
  static $pb.PbList<BuildInfra_BBAgent_Input> createRepeated() =>
      $pb.PbList<BuildInfra_BBAgent_Input>();
  @$core.pragma('dart2js:noInline')
  static BuildInfra_BBAgent_Input getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BuildInfra_BBAgent_Input>(create);
  static BuildInfra_BBAgent_Input? _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<BuildInfra_BBAgent_Input_CIPDPackage> get cipdPackages =>
      $_getList(0);
}
...
class BuildInfra_BBAgent extends $pb.GeneratedMessage {
  ...
  factory BuildInfra_BBAgent.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BuildInfra_BBAgent.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BuildInfra.BBAgent',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'payloadPath')
    ..aOS(2, _omitFieldNames ? '' : 'cacheDir')
    ..pPS(3, _omitFieldNames ? '' : 'knownPublicGerritHosts')
    ..aOM<BuildInfra_BBAgent_Input>(4, _omitFieldNames ? '' : 'input',
  ...
  static $pb.PbList<BuildInfra_BBAgent> createRepeated() =>
      $pb.PbList<BuildInfra_BBAgent>();
  @$core.pragma('dart2js:noInline')
  static BuildInfra_BBAgent getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BuildInfra_BBAgent>(create);
...
class BuildInfra_Backend extends $pb.GeneratedMessage {
  ...
  factory BuildInfra_Backend.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BuildInfra_Backend.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BuildInfra.Backend',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..aOM<$5.Struct>(1, _omitFieldNames ? '' : 'config',
        subBuilder: $5.Struct.create)
    ..aOM<$7.Task>(2, _omitFieldNames ? '' : 'task', subBuilder: $7.Task.create)
    ..pc<$3.CacheEntry>(3, _omitFieldNames ? '' : 'caches', $pb.PbFieldType.PM,
        subBuilder: $3.CacheEntry.create)
    ..pc<$3.RequestedDimension>(
        5, _omitFieldNames ? '' : 'taskDimensions', $pb.PbFieldType.PM,
        subBuilder: $3.RequestedDimension.create)
  ...
  static $pb.PbList<BuildInfra_Backend> createRepeated() =>
      $pb.PbList<BuildInfra_Backend>();
  @$core.pragma('dart2js:noInline')
  static BuildInfra_Backend getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BuildInfra_Backend>(create);
...
class BuildInfra extends $pb.GeneratedMessage {
  ...
  BuildInfra._() : super();
  factory BuildInfra.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BuildInfra.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BuildInfra',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'buildbucket.v2'),
      createEmptyInstance: create)
    ..aOM<BuildInfra_Buildbucket>(1, _omitFieldNames ? '' : 'buildbucket',
        subBuilder: BuildInfra_Buildbucket.create)
    ..aOM<BuildInfra_Swarming>(2, _omitFieldNames ? '' : 'swarming',
        subBuilder: BuildInfra_Swarming.create)
    ..aOM<BuildInfra_LogDog>(3, _omitFieldNames ? '' : 'logdog',
        subBuilder: BuildInfra_LogDog.create)
    ..aOM<BuildInfra_Recipe>(4, _omitFieldNames ? '' : 'recipe',
        subBuilder: BuildInfra_Recipe.create)
    ..aOM<BuildInfra_ResultDB>(5, _omitFieldNames ? '' : 'resultdb',
        subBuilder: BuildInfra_ResultDB.create)
    ..aOM<BuildInfra_BBAgent>(6, _omitFieldNames ? '' : 'bbagent',
        subBuilder: BuildInfra_BBAgent.create)
    ..aOM<BuildInfra_Backend>(7, _omitFieldNames ? '' : 'backend',
        subBuilder: BuildInfra_Backend.create)
    ..aOM<BuildInfra_Led>(8, _omitFieldNames ? '' : 'led',
        subBuilder: BuildInfra_Led.create)
    ..hasRequiredFields = false;
  ...
  @$core.pragma('dart2js:noInline')
  static BuildInfra getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BuildInfra>(create);
