...
class BuildersClient extends $grpc.Client {
  static final _$getBuilder =
      $grpc.ClientMethod<$0.GetBuilderRequest, $1.BuilderItem>(
  ...
  static final _$listBuilders =
      $grpc.ClientMethod<$0.ListBuildersRequest, $0.ListBuildersResponse>(
          '/buildbucket.v2.Builders/ListBuilders',
          ($0.ListBuildersRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.ListBuildersResponse.fromBuffer(value));
  static final _$setBuilderHealth = $grpc.ClientMethod<
          $0.SetBuilderHealthRequest, $0.SetBuilderHealthResponse>(
      '/buildbucket.v2.Builders/SetBuilderHealth',
      ($0.SetBuilderHealthRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.SetBuilderHealthResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.BuilderItem> getBuilder($0.GetBuilderRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getBuilder, request, options: options);
  }

  $grpc.ResponseFuture<$0.ListBuildersResponse> listBuilders(
      $0.ListBuildersRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$listBuilders, request, options: options);
  }

  $grpc.ResponseFuture<$0.SetBuilderHealthResponse> setBuilderHealth(
      $0.SetBuilderHealthRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class BuildersServiceBase extends $grpc.Service {
  ...
  BuildersServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.ListBuildersRequest, $0.ListBuildersResponse>(
            'ListBuilders',
            listBuilders_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.ListBuildersRequest.fromBuffer(value),
            ($0.ListBuildersResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.SetBuilderHealthRequest,
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.SetBuilderHealthRequest.fromBuffer(value),
        ($0.SetBuilderHealthResponse value) => value.writeToBuffer()));
  }

  $async.Future<$1.BuilderItem> getBuilder_Pre($grpc.ServiceCall call,
      $async.Future<$0.GetBuilderRequest> request) async {
    return getBuilder(call, await request);
  }

  $async.Future<$0.ListBuildersResponse> listBuilders_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.ListBuildersRequest> request) async {
    return listBuilders(call, await request);
  }

  $async.Future<$0.SetBuilderHealthResponse> setBuilderHealth_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.SetBuilderHealthRequest> request) async {
    return setBuilderHealth(call, await request);
  }

  $async.Future<$1.BuilderItem> getBuilder(
      $grpc.ServiceCall call, $0.GetBuilderRequest request);
  $async.Future<$0.ListBuildersResponse> listBuilders(
      $grpc.ServiceCall call, $0.ListBuildersRequest request);
