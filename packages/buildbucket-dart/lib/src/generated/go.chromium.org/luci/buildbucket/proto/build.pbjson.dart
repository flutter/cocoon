...
const Build$json = const {
  ...
  '2': const [
    ...
    const {'1': 'cancel_time', '3': 32, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'cancelTime'},
    ...
    const {'1': 'status_details', '3': 22, '4': 1, '5': 11, '6': '.buildbucket.v2.StatusDetails', '8': const {}, '10': 'statusDetails'},
    ...
    const {'1': 'scheduling_timeout', '3': 26, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '10': 'schedulingTimeout'},
    const {'1': 'execution_timeout', '3': 27, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '10': 'executionTimeout'},
...
const Build_Input$json = const {
  ...
  '2': const [
    ...
    const {'1': 'gitiles_commit', '3': 2, '4': 1, '5': 11, '6': '.buildbucket.v2.GitilesCommit', '8': const {}, '10': 'gitilesCommit'},
    const {'1': 'gerrit_changes', '3': 3, '4': 3, '5': 11, '6': '.buildbucket.v2.GerritChange', '8': const {}, '10': 'gerritChanges'},
...
final $typed_data.Uint8List buildDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List resolvedDataRefDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use buildInfraDescriptor instead')
const BuildInfra$json = const {
  '1': 'BuildInfra',
  '2': const [
    const {'1': 'buildbucket', '3': 1, '4': 1, '5': 11, '6': '.buildbucket.v2.BuildInfra.Buildbucket', '8': const {}, '10': 'buildbucket'},
    const {'1': 'swarming', '3': 2, '4': 1, '5': 11, '6': '.buildbucket.v2.BuildInfra.Swarming', '8': const {}, '10': 'swarming'},
    const {'1': 'logdog', '3': 3, '4': 1, '5': 11, '6': '.buildbucket.v2.BuildInfra.LogDog', '8': const {}, '10': 'logdog'},
    const {'1': 'recipe', '3': 4, '4': 1, '5': 11, '6': '.buildbucket.v2.BuildInfra.Recipe', '10': 'recipe'},
    const {'1': 'resultdb', '3': 5, '4': 1, '5': 11, '6': '.buildbucket.v2.BuildInfra.ResultDB', '8': const {}, '10': 'resultdb'},
  ...
  '3': const [BuildInfra_Buildbucket$json, BuildInfra_Swarming$json, BuildInfra_LogDog$json, BuildInfra_Recipe$json, BuildInfra_ResultDB$json, BuildInfra_BBAgent$json, BuildInfra_Backend$json],
};
...
const BuildInfra_Buildbucket$json = const {
  ...
  '2': const [
    ...
    const {'1': 'requested_properties', '3': 5, '4': 1, '5': 11, '6': '.google.protobuf.Struct', '10': 'requestedProperties'},
    const {'1': 'requested_dimensions', '3': 6, '4': 3, '5': 11, '6': '.buildbucket.v2.RequestedDimension', '10': 'requestedDimensions'},
    const {'1': 'hostname', '3': 7, '4': 1, '5': 9, '10': 'hostname'},
    const {'1': 'experiment_reasons', '3': 8, '4': 3, '5': 11, '6': '.buildbucket.v2.BuildInfra.Buildbucket.ExperimentReasonsEntry', '10': 'experimentReasons'},
    const {
      '1': 'agent_executable',
      '3': 9,
      '4': 3,
    ...
    const {'1': 'agent', '3': 10, '4': 1, '5': 11, '6': '.buildbucket.v2.BuildInfra.Buildbucket.Agent', '8': const {}, '10': 'agent'},
    const {'1': 'known_public_gerrit_hosts', '3': 11, '4': 3, '5': 9, '10': 'knownPublicGerritHosts'},
  ],
  '3': const [BuildInfra_Buildbucket_Agent$json, BuildInfra_Buildbucket_ExperimentReasonsEntry$json, BuildInfra_Buildbucket_AgentExecutableEntry$json],
...
const BuildInfra_Buildbucket_Agent$json = const {
  '1': 'Agent',
  '2': const [
    const {'1': 'input', '3': 1, '4': 1, '5': 11, '6': '.buildbucket.v2.BuildInfra.Buildbucket.Agent.Input', '8': const {}, '10': 'input'},
    const {'1': 'output', '3': 2, '4': 1, '5': 11, '6': '.buildbucket.v2.BuildInfra.Buildbucket.Agent.Output', '8': const {}, '10': 'output'},
    const {'1': 'source', '3': 3, '4': 1, '5': 11, '6': '.buildbucket.v2.BuildInfra.Buildbucket.Agent.Source', '8': const {}, '10': 'source'},
    const {'1': 'purposes', '3': 4, '4': 3, '5': 11, '6': '.buildbucket.v2.BuildInfra.Buildbucket.Agent.PurposesEntry', '10': 'purposes'},
  ],
  '3': const [BuildInfra_Buildbucket_Agent_Source$json, BuildInfra_Buildbucket_Agent_Input$json, BuildInfra_Buildbucket_Agent_Output$json, BuildInfra_Buildbucket_Agent_PurposesEntry$json],
...
const BuildInfra_Buildbucket_Agent_Source$json = const {
  '1': 'Source',
  '2': const [
    const {'1': 'cipd', '3': 1, '4': 1, '5': 11, '6': '.buildbucket.v2.BuildInfra.Buildbucket.Agent.Source.CIPD', '9': 0, '10': 'cipd'},
  ],
...
const BuildInfra_Buildbucket_Agent_Source_CIPD$json = const {
  ...
  '2': const [
    ...
    const {'1': 'resolved_instances', '3': 4, '4': 3, '5': 11, '6': '.buildbucket.v2.BuildInfra.Buildbucket.Agent.Source.CIPD.ResolvedInstancesEntry', '8': const {}, '10': 'resolvedInstances'},
  ],
...
const BuildInfra_Buildbucket_Agent_Input$json = const {
  '1': 'Input',
  '2': const [
    const {'1': 'data', '3': 1, '4': 3, '5': 11, '6': '.buildbucket.v2.BuildInfra.Buildbucket.Agent.Input.DataEntry', '10': 'data'},
  ],
...
const BuildInfra_Buildbucket_Agent_Output$json = const {
  '1': 'Output',
  '2': const [
    const {'1': 'resolved_data', '3': 1, '4': 3, '5': 11, '6': '.buildbucket.v2.BuildInfra.Buildbucket.Agent.Output.ResolvedDataEntry', '10': 'resolvedData'},
...
const BuildInfra_Buildbucket_Agent_PurposesEntry$json = const {
  ...
  '2': const [
    const {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    const {'1': 'value', '3': 2, '4': 1, '5': 14, '6': '.buildbucket.v2.BuildInfra.Buildbucket.Agent.Purpose', '10': 'value'},
  ],
  '7': const {'7': true},
};
...
const BuildInfra_Buildbucket_ExperimentReasonsEntry$json = const {
  ...
  '2': const [
    const {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    const {'1': 'value', '3': 2, '4': 1, '5': 14, '6': '.buildbucket.v2.BuildInfra.Buildbucket.ExperimentReason', '10': 'value'},
  ],
  '7': const {'7': true},
};
...
const BuildInfra_Swarming$json = const {
  ...
  '2': const [
    ...
    const {'1': 'task_dimensions', '3': 5, '4': 3, '5': 11, '6': '.buildbucket.v2.RequestedDimension', '10': 'taskDimensions'},
    const {'1': 'bot_dimensions', '3': 6, '4': 3, '5': 11, '6': '.buildbucket.v2.StringPair', '10': 'botDimensions'},
    const {'1': 'caches', '3': 7, '4': 3, '5': 11, '6': '.buildbucket.v2.BuildInfra.Swarming.CacheEntry', '10': 'caches'},
  ],
...
const BuildInfra_Swarming_CacheEntry$json = const {
  ...
  '2': const [
    ...
    const {'1': 'wait_for_warm_cache', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '10': 'waitForWarmCache'},
...
const BuildInfra_BBAgent_Input$json = const {
  '1': 'Input',
  '2': const [
    const {'1': 'cipd_packages', '3': 1, '4': 3, '5': 11, '6': '.buildbucket.v2.BuildInfra.BBAgent.Input.CIPDPackage', '10': 'cipdPackages'},
  ],
