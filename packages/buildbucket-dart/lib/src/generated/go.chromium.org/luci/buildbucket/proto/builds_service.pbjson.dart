...
final $typed_data.Uint8List getBuildRequestDescriptor = $convert.base64Decode(
    'Cg9HZXRCdWlsZFJlcXVlc3QSDgoCaWQYASABKANSAmlkEjMKB2J1aWxkZXIYAiABKAsyGS5idW'
...
final $typed_data.Uint8List searchBuildsRequestDescriptor = $convert.base64Decode(
    'ChNTZWFyY2hCdWlsZHNSZXF1ZXN0EjwKCXByZWRpY2F0ZRgBIAEoCzIeLmJ1aWxkYnVja2V0Ln'
...
final $typed_data.Uint8List searchBuildsResponseDescriptor = $convert.base64Decode(
    'ChRTZWFyY2hCdWlsZHNSZXNwb25zZRItCgZidWlsZHMYASADKAsyFS5idWlsZGJ1Y2tldC52Mi'
...
const BatchRequest_Request$json = {
  ...
  '2': [
    ...
    {'1': 'search_builds', '3': 2, '4': 1, '5': 11, '6': '.buildbucket.v2.SearchBuildsRequest', '9': 0, '10': 'searchBuilds'},
    {'1': 'schedule_build', '3': 3, '4': 1, '5': 11, '6': '.buildbucket.v2.ScheduleBuildRequest', '9': 0, '10': 'scheduleBuild'},
    {'1': 'cancel_build', '3': 4, '4': 1, '5': 11, '6': '.buildbucket.v2.CancelBuildRequest', '9': 0, '10': 'cancelBuild'},
    {'1': 'get_build_status', '3': 5, '4': 1, '5': 11, '6': '.buildbucket.v2.GetBuildStatusRequest', '9': 0, '10': 'getBuildStatus'},
  ],
  '8': [
    {'1': 'request'},
  ],
...
final $typed_data.Uint8List batchRequestDescriptor = $convert.base64Decode(
    'CgxCYXRjaFJlcXVlc3QSQAoIcmVxdWVzdHMYASADKAsyJC5idWlsZGJ1Y2tldC52Mi5CYXRjaF'
...
const BatchResponse_Response$json = {
  ...
  '2': [
    ...
    {'1': 'search_builds', '3': 2, '4': 1, '5': 11, '6': '.buildbucket.v2.SearchBuildsResponse', '9': 0, '10': 'searchBuilds'},
...
final $typed_data.Uint8List batchResponseDescriptor = $convert.base64Decode(
    'Cg1CYXRjaFJlc3BvbnNlEkQKCXJlc3BvbnNlcxgBIAMoCzImLmJ1aWxkYnVja2V0LnYyLkJhdG'
...
final $typed_data.Uint8List updateBuildRequestDescriptor = $convert.base64Decode(
    'ChJVcGRhdGVCdWlsZFJlcXVlc3QSKwoFYnVpbGQYASABKAsyFS5idWlsZGJ1Y2tldC52Mi5CdW'
...
const ScheduleBuildRequest$json = {
  ...
  '2': [
    ...
    {'1': 'experiments', '3': 16, '4': 3, '5': 11, '6': '.buildbucket.v2.ScheduleBuildRequest.ExperimentsEntry', '10': 'experiments'},
    ...
    {'1': 'shadow_input', '3': 23, '4': 1, '5': 11, '6': '.buildbucket.v2.ScheduleBuildRequest.ShadowInput', '10': 'shadowInput'},
  ],
  '3': [ScheduleBuildRequest_ExperimentsEntry$json, ScheduleBuildRequest_Swarming$json, ScheduleBuildRequest_ShadowInput$json],
};
...
final $typed_data.Uint8List scheduleBuildRequestDescriptor = $convert.base64Decode(
    'ChRTY2hlZHVsZUJ1aWxkUmVxdWVzdBIdCgpyZXF1ZXN0X2lkGAEgASgJUglyZXF1ZXN0SWQSKg'
...
final $typed_data.Uint8List cancelBuildRequestDescriptor = $convert.base64Decode(
    'ChJDYW5jZWxCdWlsZFJlcXVlc3QSDgoCaWQYASABKANSAmlkEikKEHN1bW1hcnlfbWFya2Rvd2'
...
final $typed_data.Uint8List createBuildRequestDescriptor = $convert.base64Decode(
    'ChJDcmVhdGVCdWlsZFJlcXVlc3QSMAoFYnVpbGQYASABKAsyFS5idWlsZGJ1Y2tldC52Mi5CdW'
...
const SynthesizeBuildRequest$json = {
  ...
  '2': [
    ...
    {'1': 'builder', '3': 2, '4': 1, '5': 11, '6': '.buildbucket.v2.BuilderID', '10': 'builder'},
    {'1': 'experiments', '3': 3, '4': 3, '5': 11, '6': '.buildbucket.v2.SynthesizeBuildRequest.ExperimentsEntry', '10': 'experiments'},
  ],
...
final $typed_data.Uint8List synthesizeBuildRequestDescriptor = $convert.base64Decode(
    'ChZTeW50aGVzaXplQnVpbGRSZXF1ZXN0EioKEXRlbXBsYXRlX2J1aWxkX2lkGAEgASgDUg90ZW'
...
final $typed_data.Uint8List startBuildRequestDescriptor = $convert.base64Decode(
    'ChFTdGFydEJ1aWxkUmVxdWVzdBIiCgpyZXF1ZXN0X2lkGAEgASgJQgPgQQJSCXJlcXVlc3RJZB'
...
final $typed_data.Uint8List startBuildResponseDescriptor = $convert.base64Decode(
    'ChJTdGFydEJ1aWxkUmVzcG9uc2USKwoFYnVpbGQYASABKAsyFS5idWlsZGJ1Y2tldC52Mi5CdW'
...
final $typed_data.Uint8List getBuildStatusRequestDescriptor = $convert.base64Decode(
    'ChVHZXRCdWlsZFN0YXR1c1JlcXVlc3QSDgoCaWQYASABKANSAmlkEjMKB2J1aWxkZXIYAiABKA'
...
final $typed_data.Uint8List buildMaskDescriptor = $convert.base64Decode(
    'CglCdWlsZE1hc2sSMgoGZmllbGRzGAEgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza1'
...
const BuildPredicate$json = {
  ...
  '2': [
    ...
    {'1': 'output_gitiles_commit', '3': 4, '4': 1, '5': 11, '6': '.buildbucket.v2.GitilesCommit', '10': 'outputGitilesCommit'},
...
final $typed_data.Uint8List buildPredicateDescriptor = $convert.base64Decode(
    'Cg5CdWlsZFByZWRpY2F0ZRIzCgdidWlsZGVyGAEgASgLMhkuYnVpbGRidWNrZXQudjIuQnVpbG'
...
final $typed_data.Uint8List buildRangeDescriptor = $convert.base64Decode(
    'CgpCdWlsZFJhbmdlEiQKDnN0YXJ0X2J1aWxkX2lkGAEgASgDUgxzdGFydEJ1aWxkSWQSIAoMZW'
...
final $typed_data.Uint8List startBuildTaskRequestDescriptor = $convert.base64Decode(
    'ChVTdGFydEJ1aWxkVGFza1JlcXVlc3QSIgoKcmVxdWVzdF9pZBgBIAEoCUID4EECUglyZXF1ZX'
...
final $typed_data.Uint8List startBuildTaskResponseDescriptor = $convert.base64Decode(
    'ChZTdGFydEJ1aWxkVGFza1Jlc3BvbnNlEjYKB3NlY3JldHMYASABKAsyHC5idWlsZGJ1Y2tldC'
