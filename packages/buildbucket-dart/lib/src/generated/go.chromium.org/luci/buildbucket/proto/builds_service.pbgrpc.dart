...
class BuildsClient extends $grpc.Client {
  ...
  static final _$searchBuilds = $grpc.ClientMethod<$0.SearchBuildsRequest, $0.SearchBuildsResponse>(
      ...
      ($core.List<$core.int> value) => $0.SearchBuildsResponse.fromBuffer(value));
  static final _$updateBuild = $grpc.ClientMethod<$0.UpdateBuildRequest, $1.Build>(
      '/buildbucket.v2.Builds/UpdateBuild',
      ($0.UpdateBuildRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.Build.fromBuffer(value));
  static final _$scheduleBuild = $grpc.ClientMethod<$0.ScheduleBuildRequest, $1.Build>(
      '/buildbucket.v2.Builds/ScheduleBuild',
      ($0.ScheduleBuildRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.Build.fromBuffer(value));
  static final _$cancelBuild = $grpc.ClientMethod<$0.CancelBuildRequest, $1.Build>(
  ...
  static final _$createBuild = $grpc.ClientMethod<$0.CreateBuildRequest, $1.Build>(
      '/buildbucket.v2.Builds/CreateBuild',
      ($0.CreateBuildRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.Build.fromBuffer(value));
  static final _$synthesizeBuild = $grpc.ClientMethod<$0.SynthesizeBuildRequest, $1.Build>(
      '/buildbucket.v2.Builds/SynthesizeBuild',
      ($0.SynthesizeBuildRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.Build.fromBuffer(value));
  static final _$getBuildStatus = $grpc.ClientMethod<$0.GetBuildStatusRequest, $1.Build>(
  ...
  $grpc.ResponseFuture<$1.Build> updateBuild($0.UpdateBuildRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateBuild, request, options: options);
  }

  $grpc.ResponseFuture<$1.Build> scheduleBuild($0.ScheduleBuildRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$scheduleBuild, request, options: options);
  }

  $grpc.ResponseFuture<$1.Build> cancelBuild($0.CancelBuildRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$cancelBuild, request, options: options);
  }

  $grpc.ResponseFuture<$0.BatchResponse> batch($0.BatchRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$batch, request, options: options);
  }

  $grpc.ResponseFuture<$1.Build> createBuild($0.CreateBuildRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$createBuild, request, options: options);
  }

  $grpc.ResponseFuture<$1.Build> synthesizeBuild($0.SynthesizeBuildRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$synthesizeBuild, request, options: options);
  }

  $grpc.ResponseFuture<$1.Build> getBuildStatus($0.GetBuildStatusRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.StartBuildTaskResponse> startBuildTask($0.StartBuildTaskRequest request, {$grpc.CallOptions? options}) {
...
abstract class BuildsServiceBase extends $grpc.Service {
  ...
  BuildsServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.SearchBuildsRequest, $0.SearchBuildsResponse>(
        'SearchBuilds',
        searchBuilds_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.SearchBuildsRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.UpdateBuildRequest, $1.Build>(
        ...
        false,
        false,
        ($core.List<$core.int> value) => $0.UpdateBuildRequest.fromBuffer(value),
        ($1.Build value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ScheduleBuildRequest, $1.Build>(
        ...
        false,
        false,
        ($core.List<$core.int> value) => $0.ScheduleBuildRequest.fromBuffer(value),
        ($1.Build value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.CancelBuildRequest, $1.Build>(
        ...
        false,
        false,
        ($core.List<$core.int> value) => $0.CancelBuildRequest.fromBuffer(value),
        ($1.Build value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$0.CreateBuildRequest, $1.Build>(
        ...
        false,
        false,
        ($core.List<$core.int> value) => $0.CreateBuildRequest.fromBuffer(value),
        ($1.Build value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.SynthesizeBuildRequest, $1.Build>(
        ...
        false,
        false,
        ($core.List<$core.int> value) => $0.SynthesizeBuildRequest.fromBuffer(value),
        ($1.Build value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetBuildStatusRequest, $1.Build>(
        ...
        false,
        false,
        ($core.List<$core.int> value) => $0.GetBuildStatusRequest.fromBuffer(value),
        ($1.Build value) => value.writeToBuffer()));
  ...
  $async.Future<$1.Build> updateBuild_Pre($grpc.ServiceCall call, $async.Future<$0.UpdateBuildRequest> request) async {
  ...
  $async.Future<$1.Build> cancelBuild_Pre($grpc.ServiceCall call, $async.Future<$0.CancelBuildRequest> request) async {
    return cancelBuild(call, await request);
  }

  $async.Future<$0.BatchResponse> batch_Pre($grpc.ServiceCall call, $async.Future<$0.BatchRequest> request) async {
    return batch(call, await request);
  }

  $async.Future<$1.Build> createBuild_Pre($grpc.ServiceCall call, $async.Future<$0.CreateBuildRequest> request) async {
  ...
  $async.Future<$0.StartBuildTaskResponse> startBuildTask_Pre($grpc.ServiceCall call, $async.Future<$0.StartBuildTaskRequest> request) async {
  ...
  $async.Future<$1.Build> scheduleBuild($grpc.ServiceCall call, $0.ScheduleBuildRequest request);
  $async.Future<$1.Build> cancelBuild($grpc.ServiceCall call, $0.CancelBuildRequest request);
  $async.Future<$0.BatchResponse> batch($grpc.ServiceCall call, $0.BatchRequest request);
  $async.Future<$1.Build> createBuild($grpc.ServiceCall call, $0.CreateBuildRequest request);
