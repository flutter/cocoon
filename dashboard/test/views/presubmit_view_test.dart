...
void main() {
  ...
  group('PreSubmitView Sorting', () {
    ...
    testWidgets(
      'PreSubmitView with default Settings property sheet, light mode',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'PreSubmitView with default Settings property sheet, dark mode',
      (WidgetTester tester) async {
        tester.view.physicalSize = const Size(1080, 2280);
        tester.view.devicePixelRatio = 1.0;
        addTearDown(tester.view.resetPhysicalSize);
  ...
  group('PreSubmitView Mobile Version', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          find.textContaining(
            'Start: 05/08/2026 10:05    End: 05/08/2026 10:15',
          ),
          findsOneWidget,
        );
        ...
        await tester.tap(find.text('#2'));
        await tester.pumpAndSettle();
        expect(find.textContaining('Start: 05/08/2026 10:20'), findsOneWidget);
