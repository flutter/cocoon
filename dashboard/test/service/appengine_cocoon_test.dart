...
void main() {
  ...
  group('AppEngine CocoonService presubmit methods', () {
    ...
    test('fetchPresubmitCheckDetails uses correct parameters and defaults', () async {
      await service.fetchPresubmitCheckDetails(checkRunId: 123, buildName: 'linux');
      expect(capturedUri.queryParameters['owner'], 'flutter');
    ...
    test('fetchPresubmitGuardSummaries uses correct parameters and defaults', () async {
