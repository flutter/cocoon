...
class MockCocoonService extends _i1.Mock implements _i4.CocoonService {
  ...
  _i8.Future<_i4.CocoonResponse<_i13.BuildStatusResponse>> fetchTreeBuildStatus(
      ...
      (super.noSuchMethod(
              Invocation.method(
                  #fetchTreeBuildStatus, [], {#branch: branch, #repo: repo}),
              returnValue:
  ...
  _i8.Future<_i4.CocoonResponse<List<String>>> fetchRepos() =>
      (super.noSuchMethod(Invocation.method(#fetchRepos, []),
              returnValue: Future<_i4.CocoonResponse<List<String>>>.value(
                  _FakeCocoonResponse_2<List<String>>()))
          as _i8.Future<_i4.CocoonResponse<List<String>>>);
  @override
  _i8.Future<_i4.CocoonResponse<bool>> rerunTask(
          _i14.Task? task, String? idToken, String? repo) =>
      (super.noSuchMethod(Invocation.method(#rerunTask, [task, idToken, repo]),
              returnValue: Future<_i4.CocoonResponse<bool>>.value(
                  _FakeCocoonResponse_2<bool>()))
          as _i8.Future<_i4.CocoonResponse<bool>>);
  @override
  _i8.Future<bool> vacuumGitHubCommits(String? idToken) =>
      (super.noSuchMethod(Invocation.method(#vacuumGitHubCommits, [idToken]),
...
class MockBuildState extends _i1.Mock implements _i15.BuildState {
  ...
  _i4.CocoonService get cocoonService =>
      (super.noSuchMethod(Invocation.getter(#cocoonService),
          returnValue: _FakeCocoonService_3()) as _i4.CocoonService);
  @override
  _i5.GoogleSignInService get authService => (super.noSuchMethod(
      Invocation.getter(#authService),
      returnValue: _FakeGoogleSignInService_4()) as _i5.GoogleSignInService);
  @override
  ...
  List<String> get branches =>
      (super.noSuchMethod(Invocation.getter(#branches), returnValue: <String>[])
          as List<String>);
  @override
  String get currentBranch =>
      (super.noSuchMethod(Invocation.getter(#currentBranch), returnValue: '')
          as String);
  @override
  String get currentRepo =>
      (super.noSuchMethod(Invocation.getter(#currentRepo), returnValue: '')
          as String);
  @override
  ...
  _i6.Brook<String> get errors =>
      (super.noSuchMethod(Invocation.getter(#errors),
          returnValue: _FakeBrook_5<String>()) as _i6.Brook<String>);
  @override
  ...
  void updateCurrentRepoBranch(String? repo, String? branch) => super
      .noSuchMethod(Invocation.method(#updateCurrentRepoBranch, [repo, branch]),
          returnValueForMissingStub: null);
  @override
  ...
  _i8.Future<bool> refreshGitHubCommits() =>
      (super.noSuchMethod(Invocation.method(#refreshGitHubCommits, []),
          returnValue: Future<bool>.value(false)) as _i8.Future<bool>);
  @override
  _i8.Future<bool> rerunTask(_i14.Task? task) =>
      (super.noSuchMethod(Invocation.method(#rerunTask, [task]),
          returnValue: Future<bool>.value(false)) as _i8.Future<bool>);
  @override
