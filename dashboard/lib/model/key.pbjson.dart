...
const Key$json = {
  ...
  '2': [
    ...
    {'1': 'child', '3': 4, '4': 1, '5': 11, '6': '.dashboard.Key', '10': 'child'},
  ],
  '8': [
    {'1': 'id'},
  ],
...
final $typed_data.Uint8List keyDescriptor =
    $convert.base64Decode('CgNLZXkSEgoEdHlwZRgBIAEoCVIEdHlwZRISCgN1aWQYAiABKANIAFIDdWlkEhQKBG5hbWUYAy'
        'ABKAlIAFIEbmFtZRIkCgVjaGlsZBgEIAEoCzIOLmRhc2hib2FyZC5LZXlSBWNoaWxkQgQKAmlk');
...
const RootKey$json = {
  ...
  '2': [
    ...
    {'1': 'child', '3': 2, '4': 1, '5': 11, '6': '.dashboard.Key', '10': 'child'},
  ],
};

/// Descriptor for `RootKey`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List rootKeyDescriptor =
    $convert.base64Decode('CgdSb290S2V5EhwKCW5hbWVzcGFjZRgBIAEoCVIJbmFtZXNwYWNlEiQKBWNoaWxkGAIgASgLMg'
        '4uZGFzaGJvYXJkLktleVIFY2hpbGQ=');
