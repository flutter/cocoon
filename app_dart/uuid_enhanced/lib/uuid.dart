...
class Uuid extends UnmodifiableListView<int> {
  ...
  factory Uuid.fromName(
    ...
    namespace ??= randomNamespace ? Uuid.randomUuid().toString() : NAMESPACE_NIL;

    // Convert namespace UUID to Byte List
    final Uuid bytes = Uuid.fromString(namespace);
    ...
    final Uint8List hashBytes = Uint8List.fromList(sha1.convert(bytes + nameBytes).bytes);
  ...
  @override
  bool operator ==(dynamic other) => other is Uuid && _equality.equals(other, this);
...
// Per 4.5, create a 48-bit node id (47 random bits + multicast bit = 1)
  static final Uint8List _nodeId = Uint8List.fromList(
      <int>[_seedBytes[0] | 0x01, _seedBytes[1], _seedBytes[2], _seedBytes[3], _seedBytes[4], _seedBytes[5]]);
  ...
  int get millisecondsSinceEpoch {
    return (this[0] << 8 * 3) + (this[1] << 8 * 2) + (this[2] << 8 * 1) + (this[3] << 8 * 0);
  }
