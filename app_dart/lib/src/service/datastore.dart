...
class DatastoreService {
  ...
  Future<Task?> getTaskFromBuildbucketBuild(Build build) async {
    ...
    try {
      return await Task.fromDatastore(datastore: this, commitKey: commitKey, name: build.builderId.builder);
