...
class AuthenticationProvider {
  ...
  /// Validate [idToken] against Google Auth.
  ///
  /// If [expectedAccount] is passed, an [AuthenticatedContext] will be returned iff [idToken] was generated
  /// by the given account.
  ///
  /// Otherwise, [idToken] must be generated by a Googler account or [AllowedAccount] for the flutter-dashboard client.
  Future<AuthenticatedContext> authenticateIdToken(String idToken,
      {ClientContext clientContext, Logging log, String expectedAccount}) async {
