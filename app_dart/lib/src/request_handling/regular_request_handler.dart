...
///
/// Regular requests extends by enabling request data for non-API requests
///
...
abstract class RegularRequestHandler<T extends Body> extends RequestHandler<T> {
  ...
  @protected
  Map<String, dynamic> get requestData => getValue<Map<String, dynamic>>(RegularKey.requestData);
...
class RegularKey<T> extends RequestKey<T> {
  ...
  static const RegularKey<Uint8List> requestBody = RegularKey<Uint8List>._('requestBody');
