...
class BuildStatusResponse extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  BuildStatusResponse copyWith(void Function(BuildStatusResponse) updates) => super.copyWith((message) => updates(message as BuildStatusResponse)); // ignore: deprecated_member_use
