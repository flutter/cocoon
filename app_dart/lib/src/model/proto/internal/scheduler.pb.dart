...
class Target extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Target', package: const $pb.PackageName(_omitMessageNames ? '' : 'scheduler'), createEmptyInstance: create)
    ...
    ..a<$core.bool>(19, _omitFieldNames ? '' : 'backfill', $pb.PbFieldType.OB, defaultOrMaker: true)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set bringup($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  set testbed($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(5)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(7)
  set builder($core.String v) { $_setString(5, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(9)
  set presubmit($core.bool v) { $_setBool(7, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set postsubmit($core.bool v) { $_setBool(8, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(13)
  set recipe($core.String v) { $_setString(11, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(15)
  $core.Map<$core.String, $core.String> get postsubmitProperties => $_getMap(12);
  ...
  @$pb.TagNumber(19)
  set backfill($core.bool v) { $_setBool(15, v); }
  @$pb.TagNumber(19)
