...
final $typed_data.Uint8List schedulerSystemDescriptor = $convert.base64Decode('Cg9TY2hlZHVsZXJTeXN0ZW0SCgoGY29jb29uEAESCAoEbHVjaRACEhMKD2dvb2dsZV9pbnRlcm5hbBADEgsKB3JlbGVhc2UQBA==');
...
const SchedulerConfig_PlatformProperties$json = const {
  ...
  '2': const [
    const {'1': 'properties', '3': 1, '4': 3, '5': 11, '6': '.scheduler.SchedulerConfig.PlatformProperties.PropertiesEntry', '10': 'properties'},
    const {'1': 'dimensions', '3': 2, '4': 3, '5': 11, '6': '.scheduler.SchedulerConfig.PlatformProperties.DimensionsEntry', '10': 'dimensions'},
  ],
  '3': const [SchedulerConfig_PlatformProperties_PropertiesEntry$json, SchedulerConfig_PlatformProperties_DimensionsEntry$json],
};
...
final $typed_data.Uint8List targetDescriptor = $convert.base64Decode('');
