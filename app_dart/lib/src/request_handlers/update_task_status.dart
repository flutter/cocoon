...
class UpdateTaskStatus extends ApiRequestHandler<UpdateTaskStatusResponse> {
  ...
  Future<Task> _getTaskFromEncodedKey(DatastoreService datastore) {
    ...
    final Key<dynamic> taskKey = keyHelper.decode(requestData[taskKeyParam] as String);
  ...
  Future<Key<String>> _constructCommitKey(DatastoreService datastore) async {
    ...
    final Key<String> commitKey = datastore.db.emptyKey.append(Commit, id: id);
  ...
  Future<TimeSeries> _getOrCreateTimeSeries(
    ...
    final Key<String> timeSeriesKey = Key<String>.emptyKey(Partition(null)).append(TimeSeries, id: id);
