...
void main() {
  ...
  late TaskStatusSubscription handler;
  ...
  setUp(() async {
    config = FakeConfig();
    handler = TaskStatusSubscription(
  ...
  test('throws exception if task key does not exist in datastore', () {
    ...
    tester.message = createBuildbucketPushMessage(
      ...
      result: 'SUCCESS',
      userData:
          '{\\"task_key\\":\\"$rawKey\\", \\"commit_branch\\":\\"flutter\\", \\"commit_sha\\":\\"87f88734747805589f2131753620d61b22922822\\", \\"builder_name\\":\\"TestBuilder\\"}',
    );
