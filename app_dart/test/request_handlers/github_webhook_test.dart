    ...
    {"name": "Windows Android AOT Engine", "repo": "engine"}
      ...
      test('Schedules builds when labeled', () async {
        ...
        expect(
          ...
          '[{"predicate":{"builder":{"project":"flutter","bucket":"prod"},"createdBy":"test@test","tags":[{"key":"pr","value":"123"}],"includeExperimental":true}}]',
        );
        expect(
          json.encode(verify(mockBuildBucketClient.batch(captureAny)).captured),
          '[{"requests":[{"scheduleBuild":{"builder":{"project":"flutter","bucket":"prod","builder":"Linux"},"experimental":"YES","properties":{"git_url":"https://github.com/flutter/flutter","git_ref":"pull/123/head"},"tags":[{"key":"pr","value":"123"},{"key":"github_link","value":"https://github.com/flutter/flutter/pulls/123"}]}},{"scheduleBuild":{"builder":{"project":"flutter","bucket":"prod","builder":"Mac"},"experimental":"YES","properties":{"git_url":"https://github.com/flutter/flutter","git_ref":"pull/123/head"},"tags":[{"key":"pr","value":"123"},{"key":"github_link","value":"https://github.com/flutter/flutter/pulls/123"}]}},{"scheduleBuild":{"builder":{"project":"flutter","bucket":"prod","builder":"Windows"},"experimental":"YES","properties":{"git_url":"https://github.com/flutter/flutter","git_ref":"pull/123/head"},"tags":[{"key":"pr","value":"123"},{"key":"github_link","value":"https://github.com/flutter/flutter/pulls/123"}]}},{"scheduleBuild":{"builder":{"project":"flutter","bucket":"prod","builder":"Linux Coverage"},"experimental":"YES","properties":{"git_url":"https://github.com/flutter/flutter","git_ref":"pull/123/head"},"tags":[{"key":"pr","value":"123"},{"key":"github_link","value":"https://github.com/flutter/flutter/pulls/123"}]}}]}]',
        );
      });
