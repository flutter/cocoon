...
Future<bool> killAllRunningProcessesOnWindows(String processName,
  ...
  while (tries > 0) {
    tries--;
    final pids =
        runningProcessesOnWindows(processName, processManager: processManager);
    if (pids.isEmpty) {
      return true;
    }
    for (var pid in pids) {
